...
namespace InnerRage.Interface
{
    public class VerticalTabs : TabControl
    {
        ...
        public StringAlignment TabTextHAlign
        {
            get { return _tabTextHAlign; }
            set
            {
                _tabTextHAlign = value;
                Refresh();
            }
        }

        public StringAlignment TabTextVAlign
        {
            get { return _tabTextVAlign; }
            set
            {
                _tabTextVAlign = value;
                Refresh();
            }
        }
