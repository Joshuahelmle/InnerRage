...
namespace InnerRage.Core.Managers
{
    ...
    /// </summary>
    internal class SettingsManager : Settings
    {
        ...
        public static SettingsManager Instance
        {
            get
            {
                return _settingsManager ??
                       (new SettingsManager(GlobalSettings.GetFullPathToProfile(GlobalSettings.Instance.LastUsedProfile)));
            }
        }
        ...
        {
            _settingsManager = pathToProfile != null
                ? new SettingsManager(pathToProfile)
                : new SettingsManager(GlobalSettings.GetFullPathToProfile(GlobalSettings.Instance.LastUsedProfile));
        }
