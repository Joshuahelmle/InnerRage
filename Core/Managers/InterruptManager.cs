...
namespace InnerRage.Core.Managers
{
    ...
    {
        private static readonly Stopwatch _interruptTimer = new Stopwatch();
        ...
        public static async Task<bool> CheckMyTarget()
        {
            ...
            {
                if (Main.Debug) Log.Diagnostics("in CheckMyTarget() call 2:");
        ...
        {
            Log.AppendLine(
                string.Format("Interrupted {0} after {1} milliseconds.", MyCurrentTarget.SafeName, elapsedMs),
                Colors.Gold);
